...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    std::cout << "numNodes2D = " << std::to_string(numNodes2D) << std::endl;
...
/////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    for(std::size_t step = 1; mytime < endTime; step++){
        // Runge Kutta 4
        RungeKutta4(nodeTags2D, nodeTags2DPlusBC, nodeCoord, nodeCoordParam, mytime, value, matrixF, uPlusBC, u, matrixS,\
                    timeStep, tagElement1DSorted, upwind, neighbours1D, indicesNei1, indicesNei2, matrixM_Inverted, dudt,\
                    elementTags2D, numNodes2D, NumNodesSide);
