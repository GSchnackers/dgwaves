...
void Initialization(Element & element, const int meshDim, std::string gaussType, bool frontier){
    ...
    gmsh::model::mesh::getBasisFunctions(element.elementType[0], gaussType, "IsoParametric",\
    ...
    gmsh::model::mesh::getBasisFunctions(element.elementType[0], gaussType, "GradLagrange",\
    ...
    if(frontier)
        gmsh::model::mesh::getJacobians(element.elementType[0], gaussType, element.jacobians,\
